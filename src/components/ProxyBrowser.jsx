...
export const ProxyBrowser = ({ initialUrl, onClose, searchEngine = 'duckduckgo' }) => {
  ...
  const isDomainLikelyBlocked = (url) => {
    try {
  ...
  const navigateTo = (target) => {
    ...
    // Safety timeout: if iframe fails to load cleanly in 4 seconds, turn off loading indicator
  ...
  const handleCloakPopout = (targetUrlToOpen) => {
