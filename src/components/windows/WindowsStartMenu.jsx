...
export const WindowsStartMenu = ({
  ...
  // Pinned items (clean, dark, simple style)
  const pinnedItems = [
    {
      id: 'games',
      name: 'Games Library',
    ...
    >
          ...
          <>
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                {pinnedItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-10 h-10 rounded-xl bg-[#252630] border border-white/10 flex items-center justify-center shadow-sm group-hover:border-white/20 transition-all">
            ...
            <div className="pt-2.5 border-t border-white/10">
              <div className="flex items-center justify-between mb-2 px-1">
                ...
                <span className="text-[11px] text-zinc-500">Fast play</span>
              </div>
      ...
      <div className="p-3 px-5 bg-black/30 border-t border-white/10 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="text-[10px] text-zinc-400">
              Panic Key: <kbd className="px-1 py-0.5 rounded bg-white/10 font-mono">{settings.panicKey || ']'}</kbd>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          {/* Power flyout menu */}
          {showPowerMenu && (
            <div className="absolute right-0 bottom-10 w-52 rounded-xl bg-[#25252b] border border-white/15 shadow-2xl p-1 z-50 text-xs text-white">
              <button
                onClick={() => {
