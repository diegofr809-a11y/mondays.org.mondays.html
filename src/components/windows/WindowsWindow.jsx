  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 min-w-0 pr-4 pointer-events-none">
          <GripHorizontal className="w-4 h-4 text-zinc-400 shrink-0" />
          {IconComponent && (
            <div className="w-5 h-5 rounded flex items-center justify-center text-[var(--accent-color)] shrink-0">
