...
export const CategoriesView = ({ onSelectCategory, gamesCountByCategory }) => {
  const descriptions = {
    ...
    classic: 'Timeless retro arcade and browser classics.',
    multiplayer: 'Compete or cooperate with other players worldwide.',
    casual: 'Relaxing, bite-sized mini games.',
    favorites: 'Quick access to your hand-picked favorite games.',
